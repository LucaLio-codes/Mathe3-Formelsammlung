...
\section{Interpolation}
    \subsection{Polynominterpolation}
       ...
       \subsection{Spline-Interpolation}
            ...
            \begin{equation*}
                \begin{matrix}
                    d_i = y_i - \dfrac{h_i^2}{6}M_i & c_i = \dfrac{y_{i+1} - y_i}{h_i}(M_{i+1} - M_i)
                \end{matrix}
            \end{equation*}
        ...
        \subsubsection{geschlossen}
            ...
            \begin{equation*}
                \begin{array}{c c c c c c c c c}
                    ...
                    3 & \frac{b-a}{3} & \frac{3}{8} & \frac{9}{3} & \frac{9}{3} & \frac{3}{8} & & \frac{-3f^{(4)}(\xi)}{80}h^5 & \text{3/4-Regel}\\
                    4 & \frac{b-a}{4} & \frac{14}{45} & \frac{64}{45} & \frac{24}{45} & \frac{64}{845} & \frac{14}{45} & \frac{-8f^{(6)}(\xi)}{945}h^7 & \text{Milne-Regel}\\
                \end{array}
            \end{equation*}
        \subsubsection{offen}
        \textbf{Berechnung}
...
\section{Numerische Behandlung von Anfangswertproblemen gewöhnlicher Differentialgleichungen}
    \subsection{Einführung}
        ...
        \subsubsection{Stabilitätsgebiete Einiger Verfahren}
            ...
            \begin{align*}
                ...
                R(q) &= \dfrac{\det(I-qA+q\mathbf{1}\beta^T)}{\det(I-qA)}
            \end{align*}
            \newpage
    ...
    \section{Grundbegriffe der Statistik und Wahrscheinlichkeitstheorie}
        ...
        \subsection{Lage- und Streumaßzahlen}
            ...
            \subsubsection{Zweidimensionale Messreihen}
                ...
                \end{equation*}
            \subsubsection{Regressionserade}
                \begin{align*}
                    y &= ax + b\\
                    a &= \dfrac{s_{xy}}{s_x^2}\\
                    n &= \bar{y} - a \bar{x}
            ...
            \subsubsection{Rechenregeln}
                ...
                \begin{center}
                    \begin{tabular}{l l l}
                        ...
                        \hline
                        $N(\mu, \sigma^2)$ & $\mu$ & $Var(X)$\\
                        $Ex(\lambda)$ & $\dfrac{1}{\lambda}$ & $\dfrac{1}{\lambda^2})$\\
                        $B(n,p)$ & $np$ & $np(1-p)$\\
                        \hline
                    \end{tabular}
                \end{center}
                \textbf{Tschebyschvsche Ungleichung}\\
                Es gilt
                \begin{equation*}
        ...
        \subsection{Gesetz der großen Zahlen, zentraler Grenzwertsatz}
            ...
            \subsubsection{Zentraler Grenzwertsatz}
                \begin{satz}
                    ...
                    \begin{equation*}
                        \lim_{n\rightarrow infty} P \left(
                            \dfrac{X_1+\dots+X_n- (\mu_1+\dots+\mu_n)}{\sqrt{\sigma_1^2+\dots+\sigma_n^2}}\leq <
                ...
                \begin{satz}
                    ...
                    \end{equation*} 
                    die Zufällige Maximalabweichung zwischen empiririscher und "wahrer" Verteilungsfunktion, Dann gilt
                    \begin{equation*}
                        P (\lim_{n\rightarrow \infty} D_n(X_1,\dots,X_n) = 0) =1
                    \end{equation*}
                    $D_n(X_1,\dots,X_n)$ konvergiert also mit Wahrscheinlichkeit 1 gegen 0
                \end{satz}
        \subsection{Testverteilungen und Quntilapproximationen}
    ...
    \section{Schätzverfahren und Konfidenzintervalle}
        \subsection{Grundlagen zu Schätzverfahren}
            ...
            \end{equation*}
            \begin{definition}
                Eine Folge von Schätzern $T_1,T_2,\dots$ heißt konsistent für $\tau$ wenn für alle $\epsilon > 0$ und alle $\theta \in \Theta$ gilt 
                \begin{equation*}
                    \lim_{n \rightarrow \infty} P_\theta(|T_n(X_1,\dots,X_n)-\tau(\theta)|) = 0
                \end{equation*}
        ...
        \subsection{Maximum-Likelihood-Schätzer}
            \begin{definition}
                ...
                \begin{equation*}
                    L(\theta; x_1, \dots x_n) = f_theta(x_1)f_theta(x_2)\dots f_theta(x_n)
                \end{equation*}
